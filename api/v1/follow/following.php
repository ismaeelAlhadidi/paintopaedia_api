...
$following = App\Models\Following::where('follower_id', request()->get('user_id'))->get();

if(! is_array($following) ) App\Config\Response::toJson([], 0, "error in fetch following", 200);
...
foreach($following as $follower) {
    ...
    $follower_data['userId'] = $follower->follower_id;
